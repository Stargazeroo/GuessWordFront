var ListView = Backbone.View.extend({
    ...
    render: function(){
        ...
        var regForm = new EJS({url:'/javascripts/1P/templates/template.ejs'}).render(inputFields);
        this.$el.append(regForm);
        var confirmButton = new EJS ({url:'/javascripts/1P/templates/template.ejs'}) .render(buttonGet);
